...
#define PIF_GLOBAL_FLOWKEY_MAX_LW 7
__packed_bits struct pif_global_flowkey_metadata {
    unsigned int num_metadata__cur_num:8;
    unsigned int standard_metadata__ingress_port:10;
    unsigned int __padding:14;
};

__packed_bits struct pif_global_flowkey_udp {
    unsigned int udp__dport:16;
    unsigned int __padding:16;
};

__packed_bits struct pif_global_flowkey_sflow_sample {
    unsigned int sflow_sample__eth_type:32;
    unsigned int sflow_sample__ip_flag:16;
    unsigned int __padding:16;
};

__packed_bits struct pif_global_flowkey_sflow_sample2 {
    unsigned int sflow_sample2__ip_flag:16;
    unsigned int __padding:16;
};
