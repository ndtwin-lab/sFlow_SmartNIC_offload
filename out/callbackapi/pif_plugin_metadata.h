...
/* get num_metadata.cur_num */
uint32_t pif_plugin_meta_get__num_metadata__cur_num(EXTRACTED_HEADERS_T *extracted_headers);

/* set num_metadata.cur_num */
void pif_plugin_meta_set__num_metadata__cur_num(EXTRACTED_HEADERS_T *extracted_headers, uint32_t val);

/* get recirculate_fl.fl */
uint32_t pif_plugin_meta_get__recirculate_fl__fl(EXTRACTED_HEADERS_T *extracted_headers);

/* set recirculate_fl.fl */
void pif_plugin_meta_set__recirculate_fl__fl(EXTRACTED_HEADERS_T *extracted_headers, uint32_t val);

/* get recirculate_fl.recirculate_count */
uint32_t pif_plugin_meta_get__recirculate_fl__recirculate_count(EXTRACTED_HEADERS_T *extracted_headers);

/* set recirculate_fl.recirculate_count */
void pif_plugin_meta_set__recirculate_fl__recirculate_count(EXTRACTED_HEADERS_T *extracted_headers, uint32_t val);
...
__forceinline uint32_t pif_plugin_meta_get__num_metadata__cur_num(EXTRACTED_HEADERS_T *extracted_headers)
{
    __lmem struct pif_header_num_metadata *md = (__lmem struct pif_header_num_metadata *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_num_metadata_OFF_LW);
    return PIF_HEADER_GET_num_metadata___cur_num(md);
}

__forceinline void pif_plugin_meta_set__num_metadata__cur_num(EXTRACTED_HEADERS_T *extracted_headers,uint32_t val)
{
    __lmem struct pif_header_num_metadata *md = (__lmem struct pif_header_num_metadata *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_num_metadata_OFF_LW);
    PIF_HEADER_SET_num_metadata___cur_num(md, val);
}

__forceinline uint32_t pif_plugin_meta_get__recirculate_fl__fl(EXTRACTED_HEADERS_T *extracted_headers)
{
    __lmem struct pif_header_recirculate_fl *md = (__lmem struct pif_header_recirculate_fl *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_recirculate_fl_OFF_LW);
    return PIF_HEADER_GET_recirculate_fl___fl(md);
}

__forceinline void pif_plugin_meta_set__recirculate_fl__fl(EXTRACTED_HEADERS_T *extracted_headers,uint32_t val)
{
    __lmem struct pif_header_recirculate_fl *md = (__lmem struct pif_header_recirculate_fl *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_recirculate_fl_OFF_LW);
    PIF_HEADER_SET_recirculate_fl___fl(md, val);
}

__forceinline uint32_t pif_plugin_meta_get__recirculate_fl__recirculate_count(EXTRACTED_HEADERS_T *extracted_headers)
{
    __lmem struct pif_header_recirculate_fl *md = (__lmem struct pif_header_recirculate_fl *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_recirculate_fl_OFF_LW);
    return PIF_HEADER_GET_recirculate_fl___recirculate_count(md);
}

__forceinline void pif_plugin_meta_set__recirculate_fl__recirculate_count(EXTRACTED_HEADERS_T *extracted_headers,uint32_t val)
{
    __lmem struct pif_header_recirculate_fl *md = (__lmem struct pif_header_recirculate_fl *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_recirculate_fl_OFF_LW);
    PIF_HEADER_SET_recirculate_fl___recirculate_count(md, val);
}
